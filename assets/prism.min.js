...
!function(h){function n(e,n){return"___"+e.toUpperCase()+n+"___"}Object.defineProperties(h.languages["markup-templating"]={},{buildPlaceholders:{value:function(a,r,e,t){if(a.language===r){var c=a.tokenStack=[];a.code=a.code.replace(e,(function(e){if("function"==typeof t&&!t(e))return e;for(var o,i=c.length;-1!==a.code.indexOf(o=n(r,i));)++i;return c[i]=e,o})),a.grammar=h.languages.markup}}},tokenizePlaceholders:{value:function(p,k){if(p.language===k&&p.tokenStack){p.grammar=h.languages[k];var m=0,d=Object.keys(p.tokenStack);!function e(t){for(var n=0;n<t.length&&!(m>=d.length);n++){var a=t[n];if("string"==typeof a||a.content&&"string"==typeof a.content){var r=d[m],s=p.tokenStack[r],l="string"==typeof a?a:a.content,i=n(k,r),o=l.indexOf(i);if(-1<o){++m;var u=l.substring(0,o),g=new h.Token(k,h.tokenize(s,p.grammar),"language-"+k,s),c=l.substring(o+i.length),f=[];u&&f.push.apply(f,e([u])),f.push(g),c&&f.push.apply(f,e([c])),"string"==typeof a?t.splice.apply(t,[n,1].concat(f)):a.content=f}}else a.content&&"string"!=typeof a.content&&e(a.content)}return t}(p.tokens)}}})}(Prism);
